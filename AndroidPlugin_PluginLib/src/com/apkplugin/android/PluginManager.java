...
public class PluginManager {
	 ...
	 * @return
	 */
	public static boolean startPluginIntentActivityForResult(Context context,
			Intent pluginIntent, int requestCode) {
		return PluginCache.getInstance(context)
				.startPluginIntentActivityForResult(pluginIntent, requestCode);
	}

	/**
	 * 通过PluginActivity进行启动
	 * 
	 * @param context
	 * @param activity
	 * @param dataIntent
	 * @return
	 */
	public static boolean startPluginActivityForResult(Context context,
			PluginActivity activity, Intent dataIntent, int requestCode) {
		return PluginCache.getInstance(context).startPluginActivity(activity,
				dataIntent, true, requestCode);
	}
	 ...
	 * @return
	 */
	public static boolean startPluginActivity(Context context,
			PluginActivity activity, Intent dataIntent) {
		return PluginCache.getInstance(context).startPluginActivity(activity,
				dataIntent, false, 0);
	}
	...
	public static boolean startPluginIntentActivityForResult(Context context,
			Intent pluginIntent, String apkPath, int requestCode) {
		return PluginCache.getInstance(context)
				.startPluginIntentActivityForResult(pluginIntent, apkPath,
						requestCode);
	}
	 ...
	 * @return
	 */
	public static ComponentName startPluginService(Context context,
			PluginService service, Intent dataIntent) {
		return PluginCache.getInstance(context).startPluginService(service,
				dataIntent);
	}
	 ...
	 * @return
	 */
	public static boolean bindPluginService(Context context,
			PluginService service, Intent dataIntent, ServiceConnection conn,
			int flags) {
		return PluginCache.getInstance(context).bindPluginService(service,
				dataIntent, conn, flags);
	}
	 ...
	 * @return
	 */
	public static List<PluginActivity> queryActivities(Context context,
			Intent intent) {
	 ...
	 */
	public static List<PluginActivity> queryActivities(Context context,
			Intent intent, String apkPath) {
		return PluginCache.getInstance(context)
				.queryActivities(intent, apkPath);
	}

	/**
	 * 查询所有跟intent相关的插件receiver
	 * 
	 * @param context
	 * @param intent
	 * @return
	 */
	public static List<PluginReceiver> queryReceiver(Context context,
			Intent intent) {
		return PluginCache.getInstance(context).queryReceivers(intent);
	}
	...
	public static List<PluginReceiver> queryReceiver(Context context,
			Intent intent, String apkPath) {
		return PluginCache.getInstance(context).queryReceivers(intent, apkPath);
	}

	/**
	 * 查询所有跟intent相关的插件service
	 * 
	 * @param context
	 * @param intent
	 * @return
	 */
	public static List<PluginService> queryService(Context context,
			Intent intent) {
		return PluginCache.getInstance(context).queryServices(intent);
	}
	...
	public static List<PluginService> queryService(Context context,
			Intent intent, String apkPath) {
		return PluginCache.getInstance(context).queryServices(intent, apkPath);
	}
