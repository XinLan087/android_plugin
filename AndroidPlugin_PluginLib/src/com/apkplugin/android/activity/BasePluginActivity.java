 ...
 * @author XinLan
 */
public abstract class BasePluginActivity extends Activity implements
		IActivityLife {
	...
	public String getProxyAction() {
		return PluginConst.PROXY_VIEW_ACTIVITY_ACTION;
	}
