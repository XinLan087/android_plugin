...
/**
 * 基础代理类，所有插件的FragmentActivity都是通过这个FragmentActivity进行启动，并且加载资源
 * 
 * @author wangbx
 */
public abstract class BaseProxyFragmentActivity extends FragmentActivity {

	private static final String TAG = "BaseProxyFragmentActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		System.out.println("BaseProxyFragmentActivity.onCreate()mDexPath:"+mDexPath);
	...
	protected void launchTargetActivity(final String className) {
		...
		if (mLocalClassLoader == null) {
			mLocalClassLoader = HostClassLoader.getClassLoader(mDexPath, this,
					getClassLoader());
		}
		try {
			...
			PluginLog.d(TAG, "instance = " + instance);
