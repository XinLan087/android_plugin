...
/**
 * 基础代理类，所有插件的ListActivity都是通过这个ListActivity进行启动，并且加载资源
 * 
 * @author wangbx
 */
public abstract class BaseProxyListActivity extends ListActivity {

	private static final String TAG = "BaseProxyListActivity";
	...
	protected void launchTargetActivity(final String className) {
		...
		if (mLocalClassLoader == null) {
			mLocalClassLoader = HostClassLoader.getClassLoader(mDexPath,
					BaseProxyListActivity.this, getClassLoader());
		}
		try {
