 ...
 */
public class PluginIntentFilter2 implements Parcelable,Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = -1004046921219573796L;
     ...
     */
    public static PluginIntentFilter2 create(String action, String dataType) {
        try {
            return new PluginIntentFilter2(action, dataType);
     ...
     */
    public PluginIntentFilter2(String action) {
        mPriority = 0;
        mActions = new ArrayList<String>();
        addAction(action);
    }
     ...
     *
     */
    public PluginIntentFilter2(String action, String dataType)
     ...
     */
    public PluginIntentFilter2(PluginIntentFilter2 o) {
    ...
    public final static class AuthorityEntry {
         ...
         * @return Returns either {@link PluginIntentFilter2#NO_MATCH_DATA},
         * {@link PluginIntentFilter2#MATCH_CATEGORY_PORT}, or
         * {@link PluginIntentFilter2#MATCH_CATEGORY_HOST}.
         */
     ...
     * against the filter, as described in {@link PluginIntentFilter2}; in that case,
    ...
    public void readFromXml(XmlPullParser parser) throws XmlPullParserException,
        ...
        while ((type=parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            if (tagName.equals(ACTION_STR)) {
                String name = parser.getAttributeValue(prefix, NAME_STR);
                if (name != null) {
                    addAction(name);
                }
                ...
                String mimeType= parser.getAttributeValue(prefix, "mimeType");
                ...
                String scheme= parser.getAttributeValue(prefix, "scheme");
                if (scheme != null) {
                    addDataScheme(scheme);
                }
                String path= parser.getAttributeValue(prefix, "path");
                if (path != null) {
                    addDataPath(path, PatternMatcher.PATTERN_LITERAL);
                }
                String host= parser.getAttributeValue(prefix, "host");
                String port= parser.getAttributeValue(prefix, "port");
                if (host != null) {
                    addDataAuthority(host, port);
                }
                String pathPrefix= parser.getAttributeValue(prefix, "pathPrefix");
                String pathPattern= parser.getAttributeValue(prefix, "pathPattern");
            }
    ...
    public static final Parcelable.Creator<PluginIntentFilter2> CREATOR
            = new Parcelable.Creator<PluginIntentFilter2>() {
        public PluginIntentFilter2 createFromParcel(Parcel source) {
            return new PluginIntentFilter2(source);
        }

        public PluginIntentFilter2[] newArray(int size) {
            return new PluginIntentFilter2[size];
        }
    };
    ...
    private PluginIntentFilter2(Parcel source) {
        mActions = new ArrayList<String>();
     ...
     * @return
     */
    public final boolean matchIntent(String action, String type, String scheme,
            Uri data, Set<String> categories) {
    	String TAG = "PluginIntentFilter2:matchIntent";
    	int r = match(action, type, scheme, data, categories, "");
    	PluginLog.d(TAG, "MATCH action:"+action+" RESULT :"+r);
    	if(r>0){
    		return true;
    	}
        return false;
