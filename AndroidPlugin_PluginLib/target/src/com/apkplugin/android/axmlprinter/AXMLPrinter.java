 ...
 */
package com.apkplugin.android.axmlprinter;
...
public class AXMLPrinter {
	...
	/*
	 * public static void main(String[] arguments) { if (arguments.length<1) {
	 * System.out.println("Usage: AXMLPrinter <APK FILE PATH>"); return; } //
	 * String apkPath = "E:/apk_file/201008300227127991.apk"; String apkPath =
	 * arguments[0]; System.out.println(getManifestXMLFromAPK(apkPath)); }
	 */

	public static String getManifestXMLFromAPK(InputStream inputstream) {
